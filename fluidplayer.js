...
var fluidPlayerClass = {
    ...
    onFluidPlayerPause: function() {
        ...
        setTimeout(function () {
            ...
            if (player && !player.recentWaiting) {
    ...
    keyboardControl: function () {
        ...
        window.addEventListener('click', player.handleClickOutside);
    },
    ...
    setCustomControls: function() {
        ...
        //Set the progressbar
        videoPlayerTag.addEventListener('timeupdate', player.onTimeUpdate);
    ...
    init: function(idVideoPlayer, options) {
        ...
        player.handleClickOutside = function (e) {
        ...
        player.destroy = () => {
            ...
            for(var i = 0; i < fluidPlayerClass.instances.length; i++){
                var videoPlayerInstance = fluidPlayerClass.instances[i];
